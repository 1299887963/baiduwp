...
<li class="nav-item">
<a class="nav-link" href="TkzcM/baiduwp" target="_blank">777</a>
</li>
</ul>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link" href="TkzcM/baiduwp" target="_blank">666</a>
</li>
</ul>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link" href="TkzcM/baiduwp" target="_blank">111</a>
</li>
</ul>
</div>
</div>
...
<hr>
<p class="card-text"><a href="./help">无法播放，修改UA为zlx</a><br><div id="dplayer"></div></p>
</div>
</div>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link" href="TkzcM/baiduwp" target="_blank">222</a>
</li>
</ul>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link" href="TkzcM/baiduwp" target="_blank">sy37010 nb 内部使用-333</a>
</li>
</ul>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link" href="TkzcM/baiduwp" target="_blank">444</a>
</li>
</ul>
</div>
</div>
...
<h4>IDM</h4>
<ol>
<li>选项 -> 下载 -> 手动添加任务时使用的用户代理（UA）-> 填入 <b>zlx</b></li>
...
<li>New User-Agent String 填入 zlx</li>
<li>Group 填入 百度网盘</li>
...
<h4>via浏览器（Android）</h4>
<ol>
<li>设置 –&gt; 浏览设置 -&gt; 浏览器标识(UA)</li>
<li>添加自定义UA：zlx</li>
</ol>
<blockquote>
<p>酷安下载，<a href="https://www.coolapk.com/apk/mark.via" target="_blank">请点此下载</a></p>
</blockquote>
...
<h4>Alook浏览器（IOS）</h4>
<ol>
<li>设置 -&gt; 通用设置 -&gt; 浏览器标识 -&gt; 移动版浏览器标识 -&gt; 自定义 -><br> 填入 <b>zlx</b></li>
</ol>
</section>
</div>
</p>
...
const headerOption = ['User-Agent: zlx']
let post
let postVer
if(token != ""){
postVer = JSON.stringify({	
...
<li class="nav-item">
<a class="nav-link" href="TkzcM/baiduwp" target="_blank">555</a>
</li>
</ul>
</div>
</div>
...
const download = async request => {
  ...
  dresult = `<div class="alert alert-primary" role="alert">
    ...
    <hr>
    文件名：<b id="filename">${filename}</b>
    <p>下载工具的User Agent设置为zlx才可以下载</p>
